...
function createNotesCard(title, para) {
  ...
  parentDiv.className =
    "bg-[#F5F8FF] mt-2 mb-2 border border-[#A1A3AB] rounded-xl w-sm h-[166px] p-4";

  const heading = document.createElement("h2");
  heading.className = "text-base font-semibold text-lg leading-tight";
  const paragraph = document.createElement("p");
  paragraph.className = "text-sm text-[#747474] mt-2 w-64";
